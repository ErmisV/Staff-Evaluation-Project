...
public class FakelosErgazomenou extends javax.swing.JFrame 
{
    Connection con = null;
    Statement st = null;
    String eusrname;
    ...
    public FakelosErgazomenou(String eusrname) 
    {
        this.eusrname=eusrname;
        empusrname=JOptionPane.showInputDialog("Δώσε username employee");
        ResultSet rs = null;
        ...
        catch(Exception ex)
        {
         ...
         try
         {     
            rs=con.createStatement().executeQuery(" select username,sistatikes,certificates,awards from employee inner join"
                    + " company on "
                    + "employee.firm=company.AFM inner join manager on employee.firm=manager.firm and "
                    + " manager.managerusername= '"+eusrname+"'"+" and employee.username='"+empusrname+"'");
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Show/Change Employess Portfolio");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(txtawards, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 98, Short.MAX_VALUE)
                            .addComponent(txtcertificates, javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtsistatikes, javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void txtchangeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtchangeActionPerformed
        theQuery("update employee set sistatikes='"+txtsistatikes.getText()+"',certificates='"+txtcertificates.getText()+"',awards='"+txtawards.getText()+"' where username = '"+txtusername.getText()+"'");
        setVisible(false); 
        dispose();      
